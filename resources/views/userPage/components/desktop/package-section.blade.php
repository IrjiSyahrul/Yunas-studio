                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100 product-card">
                        ...
                        <div class="overflow-hidden" style="height: 256px;">
                            ...
                            <img src="{{ asset($product->image) }}"
                                class="card-img-top w-100 h-100 object-fit-cover product-image" alt="{{ $product->name }}">
                        ...
                        <div class="card-body p-4">
                            ...
                            <button class="btn btn-dark" onclick="showProductDetail('{{ $product->id }}'); return false;">
                                Lihat Paket
                            </button>
                        </div>
                    </div>
