    ...
    <div class="container py-5">
        ...
        <div class="bg-white border border-primary rounded-4 shadow-sm p-4 p-md-5">
            ...
            <div class="row text-center g-4 position-relative">
                ...
                <button class="btn btn-dark rounded-pill px-4 py-2 fw-semibold" data-bs-toggle="modal"
                    data-bs-target="#bookingModal" style="border:1px solid rgba(255,255,255,0.5);">
